...
Revision ID: 572585662f47
Revises: 
Create Date: 2024-02-02 21:34:54.377505
...
def upgrade():
    ...
    op.create_table('scrape_data',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('location', sa.String(), nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('first_dose', sa.Integer(), nullable=False),
    sa.Column('second_dose', sa.Integer(), nullable=True),
    sa.Column('manufacturer', sa.String(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default='now()', nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('location', 'date', 'manufacturer', name='date_location_sc')
    )
